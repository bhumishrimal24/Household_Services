        ...
        <div class="card-body">
            ...
            <form action="scripts/bookhall.php" method="post">
                ...
                <div class="form-group">
                    <label for="">First Name</label>&nbsp;<font color="#ff0000">*</font>
                    <input id="fname" name="fname" type="text" class="form-control" placeholder="First Name" required>
                </div>

                <div class="form-group">
                    <label for="">Last Name</label>&nbsp;<font color="#ff0000">*</font>
                ...
                <div class="form-group">
                    <label for="">Address</label>&nbsp;<font color="#ff0000">*</font>
                    <input id="adder" name="adder" type="text" class="form-control" placeholder="Address"
                        maxlength="255" required>
                </div>

                <div class="form-group">
                    <label for="">Date</label>&nbsp;<font color="#ff0000">*</font>
                    <input class="form-control" type="date" name="date" id="date" required>
                </div>

                <div class="form-group">
                    <label for="">Payment Mode</label>&nbsp;<font color="#ff0000">*</font>
                ...
                <div class="form-group">
                    <label for="">Problem</label>&nbsp;<font color="#ff0000">*</font>

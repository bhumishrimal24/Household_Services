    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title">
                <h3 class="text-center">Register as Technician</h3>
            </div>
            <hr>

            <form action="scripts/register.php" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    <label for="">Name</label>&nbsp;<font color="#ff0000">*</font>
                    <input id="name" name="name" type="text" class="form-control" placeholder="Name" required>
                </div>

                <div class="form-group">
                    <label for="">Contact No.</label>&nbsp;<font color="#ff0000">*</font>
                    <input id="contact"
                ...
                <div class="form-group">
                    <label for="">Address Line 1</label>&nbsp;<font color="#ff0000">*</font>
                ...
                <div class="form-group">
                    <label for="">City</label>&nbsp;<font color="#ff0000">*</font>
